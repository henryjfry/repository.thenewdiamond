"""General utils for the fake_useragent_new package."""
...
from fake_useragent_new.errors import FakeUserAgentError
from fake_useragent_new.log import logger
...
def load() -> list[BrowserUserAgentData]:
    ...
    try:
        json_lines = (
            ilr.files("fake_useragent_new.data").joinpath("browsers.jsonl").read_text()
        )
        ...
        try:
            ...
            with open(
                resource_filename("fake_useragent_new", "data/browsers.jsonl")
            ) as file:
