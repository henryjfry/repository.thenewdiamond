...
try: from rebulk import Rebulk, RemoveMatch, Rule, AppendMatch, RenameMatch  #PATCH
except: from a4kscrapers_wrapper.rebulk import Rebulk, RemoveMatch, Rule, AppendMatch, RenameMatch  #PATCH
...
try: from rebulk.utils import is_iterable  #PATCH
except: from a4kscrapers_wrapper.rebulk.utils import is_iterable  #PATCH


try: from guessit.rules import match_processors  #PATCH
except: from a4kscrapers_wrapper.guessit.rules import match_processors  #PATCH

try: from guessit.rules.common.numeral import parse_numeral, numeral  #PATCH
except: from a4kscrapers_wrapper.guessit.rules.common.numeral import parse_numeral, numeral  #PATCH
