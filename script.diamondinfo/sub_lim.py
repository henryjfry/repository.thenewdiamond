...
import os
import sys
sys.path.insert(0, os.path.join(os.path.abspath(os.path.dirname(__file__)), 'a4kscrapers_wrapper','Subliminal'))
...
#	for provider in ['opensubtitles','podnapisi','tvsubtitles','gestdown','subtitulamos','napiprojekt']:
	for provider in ['opensubtitles','tvsubtitles','gestdown','subtitulamos','napiprojekt']:
		#'addic7ed',
		tools.log(provider)
