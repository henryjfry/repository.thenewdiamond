...
def load_config(options):
    ...
    if not options.get('no_default_config'):
        try: default_options_data = read_text('guessit.config', 'options.json')  #PATCH
        except: default_options_data = read_text('a4kscrapers_wrapper.guessit.config', 'options.json')  #PATCH
