...
try: from rebulk.validators import chars_before, chars_after, chars_surround  #PATCH
except: from a4kscrapers_wrapper.rebulk.validators import chars_before, chars_after, chars_surround  #PATCH
