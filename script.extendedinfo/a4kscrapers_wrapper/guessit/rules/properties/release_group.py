...
try: from rebulk import Rebulk, Rule, AppendMatch, RemoveMatch  #PATCH
except: from a4kscrapers_wrapper.rebulk import Rebulk, Rule, AppendMatch, RemoveMatch  #PATCH
