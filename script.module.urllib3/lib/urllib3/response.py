...
class HTTPResponse(BaseHTTPResponse):
    ...
    def _raw_read(
        ...
        #import xbmc
        #xbmc.log(str(dict(self.headers))+'URLLIB_HEADERS', level=xbmc.LOGINFO)
        with self._error_catcher():
            ...
            if amt is not None and amt != 0 and not data:
                ...
                if (
                    ...
                    #if self.length_remaining > 1: raise IncompleteRead(self._fp_bytes_read, self.length_remaining) ## PATCH
                    raise IncompleteRead(self._fp_bytes_read, self.length_remaining) ## PATCH
