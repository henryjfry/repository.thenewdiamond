...
try: from rebulk.__version__ import __version__ as __rebulk_version__  #PATCH
except: from a4kscrapers_wrapper.rebulk.__version__ import __version__ as __a4kscrapers_wrapper.rebulk_version__  #PATCH


try: from guessit import api  #PATCH
except: from a4kscrapers_wrapper.guessit import api  #PATCH

try: from guessit.__version__ import __version__  #PATCH
except: from a4kscrapers_wrapper.guessit.__version__ import __version__  #PATCH

try: from guessit.jsonutils import GuessitEncoder  #PATCH
except: from a4kscrapers_wrapper.guessit.jsonutils import GuessitEncoder  #PATCH

try: from guessit.options import argument_parser, parse_options, load_config, merge_options  #PATCH
except: from a4kscrapers_wrapper.guessit.options import argument_parser, parse_options, load_config, merge_options  #PATCH
