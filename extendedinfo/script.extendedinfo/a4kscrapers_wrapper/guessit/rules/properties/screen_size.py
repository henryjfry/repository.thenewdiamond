...
try: from rebulk import Rebulk, Rule, RemoveMatch, AppendMatch  #PATCH
except: from a4kscrapers_wrapper.rebulk import Rebulk, Rule, RemoveMatch, AppendMatch  #PATCH
