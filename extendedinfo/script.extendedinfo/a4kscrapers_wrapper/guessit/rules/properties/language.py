...
import babelfish
try: from rebulk import Rebulk, Rule, RemoveMatch, RenameMatch  #PATCH
except: from a4kscrapers_wrapper.rebulk import Rebulk, Rule, RemoveMatch, RenameMatch  #PATCH
