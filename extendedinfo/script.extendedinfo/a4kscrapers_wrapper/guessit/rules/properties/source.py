...
try: from rebulk import AppendMatch, Rebulk, RemoveMatch, Rule  #PATCH
except: from a4kscrapers_wrapper.rebulk import AppendMatch, Rebulk, RemoveMatch, Rule  #PATCH
